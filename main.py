...
def train():
   ...
   # target_forward1=generator(target1, reuse=True,net_name="net_forward")
    ...
    tvDiff_loss_forward=tf.reduce_mean(tf.image.total_variation(forward1)) /pixel_num * configPara.tvDiff_lambda/10000
    ...
    for epoch in range(0, n_epoch+1):
        ...
        for idx in range(0, 1000, 1):
            ...
            tvDiff_loss,L1_loss, _ \
            = sess.run([tvDiff_loss_forward,L1_loss_forward,optim_forward], \
        ...
        % (epoch, n_epoch, n_iter, time.time() - epoch_time,sum_all_loss/n_iter,sum_tvDiff_loss/n_iter,sum_L1_loss/n_iter))
